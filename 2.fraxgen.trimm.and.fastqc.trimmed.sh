...
java -jar /usr/product/bioinfo/SL_7.0/BIOINFORMATICS/TRIMMOMATIC/0.36/trimmomatic-0.36.jar PE -threads 48 -phred33 $INPUT/*_${sample}_R1_001.fastq.gz $INPUT/${sample}_R2_001.fastq.gz $TRIMMED/${sample}_R1_p.fastq.gz $TRIMMED/UNPAIRED/${sample}_R1_u.fastq.gz $TRIMMED/${sample}_R2_p.fastq.gz $TRIMMED/UNPAIRED/${sample}_R2_u.fastq.gz ILLUMINACLIP:/scratch/users/chano/TGC_WES/0.APPS/adapters.fa:2:30:10 CROP:49 HEADCROP:10 SLIDINGWINDOW:4:15 MINLEN:20
