...
FASTA=$SCRATCH/ULMI/TRANSCRIPTOME/ulmi_unigenes.fasta
DB=$SCRATCH/NCBI.REF.SEQ
OUTPUT=$SCRATCH/ULMI/5.ANNOTATION/UNIGENES_BLASTX
...
blastx -query $FASTA -db $DB/refseq_plants -evalue 0.00001 -out $OUTPUT/ulmi.unigenes -outfmt 14 -max_target_seqs 50 -num_threads 48
...
#-------------------------------------------------------------------------------
# Excute this script as sbatch $SCRATCH/ULMI/0.APPS/5.ulmi.blast.sh
#-------------------------------------------------------------------------------