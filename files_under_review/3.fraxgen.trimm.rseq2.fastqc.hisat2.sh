...
echo 'eso fue antes, ahora solo voy a hacer mapping con hisat2 con las 7 muestras resecuenciadas'
echo 'para después correr htseq con todas las muestras cambiando las malas por las 7 resecuenciadas'
...
#-------------------------------------------------------------------------------
# Excute this script as sbatch $SCRATCH/FRAXGEN/0.APPS/3.fraxgen.trimm.rseq2.fastqc.hisat2.sh
#-------------------------------------------------------------------------------
