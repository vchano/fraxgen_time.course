...
#SBATCH -n 48
#SBATCH -N 1
#SBATCH --job-name=FRAX.FQC1_3
#SBATCH --output=FASTQC1.3_%J_out.txt
#SBATCH --error=FASTQC1.3_%J_err.txt
#SBATC --exclusive
...
OUTPUT=$SCRATCH/FRAXGEN/1.QC/RAWDATA/RSEQ/RSEQ2
...
#-------------------------------------------------------------------------------
# Excute this script as sbatch $SCRATCH/FRAXGEN/0.APPS/1.fraxgen.rseq2.fastqc.rawdata.sh
#-------------------------------------------------------------------------------
